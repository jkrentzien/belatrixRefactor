...
public class MainTests {
	...
	public static void main(String[] args) {
		...
		JobLogger logger1 = new JobLogger2(false,false,false,false,false,false);
		try {
		...
		JobLogger logger2 = new JobLogger2(true,false,false,false,false,false);
		try {
		...
		JobLogger logger3 = new JobLogger2(true,false,false,true,false,false);
		try {
		...
		JobLogger logger4 = new JobLogger2(false,true,false,true,false,true);
		try {
		...
		JobLogger logger5 = new JobLogger2(false,false,true,true,false,true);
		try {
		...
		//MENSAJE EN FILE
		JobLogger logger6 = new JobLogger2(true,false,false,false,true,false);
		try {
		...
		JobLogger logger7 = new JobLogger2(true,false,true,false,true,false);
		try {
